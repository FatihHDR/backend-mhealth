...
class StoreWellnessRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'title.required_without_all' => 'Judul wajib diisi (title, en_title, atau id_title)',
            ...
            'vendor_id.uuid' => 'Vendor ID harus berupa UUID yang valid',
